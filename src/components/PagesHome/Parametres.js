...
export default class Parametres extends Component {
    ...
    verify0 =async () => {
        ...
        {
          await  this.setState({nom:this.state.nom1,prenom:this.state.prenom1,ville:this.state.ville1,adresse:null});
            this.update1();
            this.setState({open0:!this.state.open0});
            alert('modif avec succés');
        }
        ...
        {
        await    this.setState({nom:this.state.nom1,prenom:this.state.prenom1,adresse:this.state.adresse1,ville:null});
            this.update1();
            this.setState({open0:!this.state.open0});
            alert('modif avec succés');
        }
        ...
        {
            await this.setState({nom:this.state.nom1,prenom:this.state.prenom1,adresse:null,ville:null});
            this.update1();
            this.setState({open0:!this.state.open0});
            alert('modif avec succés');
                    ...
                    <ScrollView >
                        { this.state.open0?
                            <TouchableOpacity onPress={async ()=>
                            {
                                ...
                                this.onedit0();
                                if(this.state.ville !==''&& this.state.ville!==null)
                                {
                                    this.setState({openville:true})
                                }else {
                                    this.setState({openville:false})
                                }
                                if(this.state.adresse !==''&& this.state.adresse!==null)
                                {
