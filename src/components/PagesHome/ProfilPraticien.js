            ...
            <SafeAreaView style={styles.maincontainer}>
                ...
                <ScrollView>
                    ...
                    <View style={styles.container1}>
                        ...
                        {
                            this.state.Contact[0].email.map((item)=>( <Text style={styles.TextNiv3}>{item.email}</Text>))
                        }
                        <Text style={styles.TextNiv3}>portable :</Text>
                        {
                            this.state.Contact[0].portable.map((item)=>( <Text style={styles.TextNiv3}>{item.numeroP}</Text>

                            ))
                        }
                        <Text style={styles.TextNiv3}>fax :</Text>
                        {
                            this.state.Contact[0].fax.map((item)=>( <Text style={styles.TextNiv3}>{item.numeroFax}</Text>

                            ))
                        }
                        <Text style={styles.TextNiv3}>fixe :</Text>
                        {
                            this.state.Contact[0].fixe.map((item)=>( <Text style={styles.TextNiv3}>{item.numeroF}</Text>
                        ...
                        <ScrollView  style={{ flex: 1 }}
                                     ...
                                     nestedScrollEnabled = {true}>
                            {
                                this.state.jours.map((itam, i) => (
                                    itam.jour.toString() === startDate.concat(' (CET)').toString() ? (
                    ...
                    <View style={styles.container1}>
                        <Text style={styles.TextCalender}>Cabinet</Text>
                        {
                            ...
                            <MapView
                                mapBoxApiKey={"pk.eyJ1IjoiYWNoMDJyYWYiLCJhIjoiY2thenZpNHd5MDIybjJ5bXR3NW4zazRmbiJ9.04grBsf5HhN-BmtWVN5PXg"}
